...
require("lazy").setup(
    {
        ...
        },
        {
            ...
            event = "VeryLazy",
            opts = {
                grace_period = 3600 * 3, -- in seconds
            },
        },
        {
        ...
        },
        {
            ...
            config = function()
                ...
                vim.keymap.set("n", "<leader>yd", genghis.copyDirectoryPath)
                ...
                vim.keymap.set("n", "<leader>yc", genghis.chmodx)
        ...
        },
        {
            ...
            config = function()
                ...
                require("nvim-web-devicons").set_default_icon(defaultIcon, "#7a88bd", 0)
            end,
        },
        {
